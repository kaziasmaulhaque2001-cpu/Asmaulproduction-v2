...
export const BrandSettingsView: React.FC = () => {
  ...
  // Active Tab
  const [activeTab, setActiveTab] = useState<'profile' | 'branding' | 'bookings' | 'whatsapp' | 'payments' | 'team' | 'sync' | 'account' | 'about'>('profile');
                                  ...
                                  {assigned.map((booking) => (
                                    <div key={booking.id} className="p-3 bg-[#141413] rounded border border-[#D4AF37]/10 flex flex-col space-y-2">
                                      <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-[10px] font-mono text-gray-400">{formatDateToDDMMYYYY(booking.weddingDate)}</span>
                                      </div>
